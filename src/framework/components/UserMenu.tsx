  ...
  return (
    <div ref={menuRef} className="fixed top-3 right-3 z-50">
      <button
        ...
        className="group relative flex items-center gap-2 bg-white/80 backdrop-blur-md border border-neutral-200 rounded-full py-1 pl-1 hover:pr-3 hover:bg-white transition-[padding,background-color] duration-300 ease-out shadow-sm"
      >
        {user ? (
          <>
            <img
